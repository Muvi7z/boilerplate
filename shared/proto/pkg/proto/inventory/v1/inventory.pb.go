...
func (x *PartFilter) GetUuids() []*wrapperspb.StringValue {
	if x != nil {
		return x.Uuids
	}
	return nil
...
func (x *PartFilter) GetNames() []*wrapperspb.StringValue {
	if x != nil {
		return x.Names
	}
	return nil
...
func (x *PartFilter) GetManufacturerCountries() []*wrapperspb.StringValue {
	if x != nil {
...
func (x *PartFilter) GetTags() []*wrapperspb.StringValue {
	if x != nil {
		return x.Tags
	}
	return nil
...
type ListPartRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Filter        []*PartFilter          `protobuf:"bytes,1,rep,name=filter,proto3" json:"filter,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *Value) GetOne() isValue_One {
	if x != nil {
		return x.One
	}
	return nil
...
func (x *Value) GetStringValue() string {
	if x != nil {
		if x, ok := x.One.(*Value_StringValue); ok {
...
func (x *Value) GetInt64Value() string {
	if x != nil {
		if x, ok := x.One.(*Value_Int64Value); ok {
			return x.Int64Value
		}
	}
	return ""
...
func (x *Value) GetDoubleValue() float64 {
	if x != nil {
		if x, ok := x.One.(*Value_DoubleValue); ok {
...
func (x *Value) GetBoolValue() bool {
	if x != nil {
		if x, ok := x.One.(*Value_BoolValue); ok {
			return x.BoolValue
		}
	}
	return false
...
const file_inventory_v1_inventory_proto_rawDesc = "" +
	"\n" +
	"\x1cinventory/v1/inventory.proto\x12\finventory.v1\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1egoogle/protobuf/wrappers.proto\x1a\x1bgoogle/protobuf/empty.proto\"\xdd\x04\n" +
	"\bPartInfo\x12\x12\n" +
	...
	"\bmetadata\x18\n" +
	" \x03(\v2$.inventory.v1.PartInfo.MetadataEntryR\bmetadata\x129\n" +
	"\n" +
	...
	"\x04part\x18\x01 \x01(\v2\x16.inventory.v1.PartInfoR\x04part\"\xb3\x02\n" +
	"\n" +
	"PartFilter\x122\n" +
	...
	"\x04tags\x18\x05 \x03(\v2\x1c.google.protobuf.StringValueR\x04tags\"C\n" +
	"\x0fListPartRequest\x120\n" +
	"\x06filter\x18\x01 \x03(\v2\x18.inventory.v1.PartFilterR\x06filter\"@\n" +
	"\x10ListPartResponse\x12,\n" +
	"\x05parts\x18\x01 \x03(\v2\x16.inventory.v1.PartInfoR\x05parts\"V\n" +
	"\fManufacturer\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x18\n" +
	"\acountry\x18\x02 \x01(\tR\acountry\x12\x18\n" +
	"\awebsite\x18\x03 \x01(\tR\awebsite\"\x9c\x01\n" +
	"\x05Value\x12#\n" +
	...
	"\n" +
	"bool_value\x18\x04 \x01(\bH\x00R\tboolValueB\x05\n" +
	"\x03one\"j\n" +
	"\n" +
	"Dimensions\x12\x16\n" +
	...
	"\x06weight\x18\x04 \x01(\x01R\x06weight*E\n" +
	"\bCategory\x12\v\n" +
	...
	"\x04WING\x10\x042\xa9\x01\n" +
	"\x10InventoryService\x12H\n" +
	"\aGetPart\x12\x1c.inventory.v1.GetPartRequest\x1a\x1d.inventory.v1.GetPartResponse\"\x00\x12K\n" +
	"\bListPart\x12\x1d.inventory.v1.ListPartRequest\x1a\x1e.inventory.v1.ListPartResponse\"\x00BTZRgithub.com/Muvi7z/boilerplate/shared/pkg/proto/inventory/inventory.v1;inventory_v1b\x06proto3"
...
var file_inventory_v1_inventory_proto_depIdxs = []int32{
	...
	12, // 7: inventory.v1.PartFilter.uuids:type_name -> google.protobuf.StringValue
	12, // 8: inventory.v1.PartFilter.names:type_name -> google.protobuf.StringValue
	0,  // 9: inventory.v1.PartFilter.categories:type_name -> inventory.v1.Category
	12, // 10: inventory.v1.PartFilter.manufacturer_countries:type_name -> google.protobuf.StringValue
	12, // 11: inventory.v1.PartFilter.tags:type_name -> google.protobuf.StringValue
	4,  // 12: inventory.v1.ListPartRequest.filter:type_name -> inventory.v1.PartFilter
	1,  // 13: inventory.v1.ListPartResponse.parts:type_name -> inventory.v1.PartInfo
	8,  // 14: inventory.v1.PartInfo.MetadataEntry.value:type_name -> inventory.v1.Value
	2,  // 15: inventory.v1.InventoryService.GetPart:input_type -> inventory.v1.GetPartRequest
	5,  // 16: inventory.v1.InventoryService.ListPart:input_type -> inventory.v1.ListPartRequest
	3,  // 17: inventory.v1.InventoryService.GetPart:output_type -> inventory.v1.GetPartResponse
	6,  // 18: inventory.v1.InventoryService.ListPart:output_type -> inventory.v1.ListPartResponse
