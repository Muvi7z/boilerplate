...
const file_iam_v1_iam_proto_rawDesc = "" +
	"\n" +
	"\x10iam/v1/iam.proto\x12\x06iam.v1\"\xa8\x01\n" +
	"\x0fRegisterRequest\x12\x14\n" +
	"\x05login\x18\x01 \x01(\tR\x05login\x12\x1a\n" +
	"\bpassword\x18\x02 \x01(\tR\bpassword\x12\x14\n" +
	"\x05email\x18\x03 \x01(\tR\x05email\x12M\n" +
	"\x14notification_methods\x18\x04 \x03(\v2\x1a.iam.v1.NotificationMethodR\x13notificationMethods\"/\n" +
	...
	"\tuser_uuid\x18\x01 \x01(\tR\buserUuid\"\xa9\x01\n" +
	"\x0fGetUserResponse\x12\x1b\n" +
	"\tuser_uuid\x18\x01 \x01(\tR\buserUuid\x12\x14\n" +
	"\x05login\x18\x02 \x01(\tR\x05login\x12\x14\n" +
	"\x05email\x18\x03 \x01(\tR\x05email\x12M\n" +
	"\x14notification_methods\x18\x04 \x03(\v2\x1a.iam.v1.NotificationMethodR\x13notificationMethods\"Q\n" +
	"\x12NotificationMethod\x12#\n" +
	"\rprovider_name\x18\x01 \x01(\tR\fproviderName\x12\x16\n" +
	"\x06target\x18\x02 \x01(\tR\x06target2\xfe\x01\n" +
	"\n" +
	"IAMService\x12?\n" +
	"\bRegister\x12\x17.iam.v1.RegisterRequest\x1a\x18.iam.v1.RegisterResponse\"\x00\x126\n" +
	"\x05Login\x12\x14.iam.v1.LoginRequest\x1a\x15.iam.v1.LoginResponse\"\x00\x129\n" +
	"\x06Whoami\x12\x15.iam.v1.WhoamiRequest\x1a\x16.iam.v1.WhoamiResponse\"\x00\x12<\n" +
	"\aGetUser\x12\x16.iam.v1.GetUserRequest\x1a\x17.iam.v1.GetUserResponse\"\x00BBZ@github.com/Muvi7z/boilerplate/shared/pkg/proto/iam/iam.v1;iam_v1b\x06proto3"
...
var file_iam_v1_iam_proto_goTypes = []any{
	...
	(*WhoamiRequest)(nil),      // 4: iam.v1.WhoamiRequest
	(*WhoamiResponse)(nil),     // 5: iam.v1.WhoamiResponse
	(*GetUserRequest)(nil),     // 6: iam.v1.GetUserRequest
	(*GetUserResponse)(nil),    // 7: iam.v1.GetUserResponse
	(*NotificationMethod)(nil), // 8: iam.v1.NotificationMethod
}
var file_iam_v1_iam_proto_depIdxs = []int32{
	8, // 0: iam.v1.RegisterRequest.notification_methods:type_name -> iam.v1.NotificationMethod
	8, // 1: iam.v1.GetUserResponse.notification_methods:type_name -> iam.v1.NotificationMethod
	0, // 2: iam.v1.IAMService.Register:input_type -> iam.v1.RegisterRequest
	2, // 3: iam.v1.IAMService.Login:input_type -> iam.v1.LoginRequest
	4, // 4: iam.v1.IAMService.Whoami:input_type -> iam.v1.WhoamiRequest
	6, // 5: iam.v1.IAMService.GetUser:input_type -> iam.v1.GetUserRequest
	1, // 6: iam.v1.IAMService.Register:output_type -> iam.v1.RegisterResponse
	3, // 7: iam.v1.IAMService.Login:output_type -> iam.v1.LoginResponse
	5, // 8: iam.v1.IAMService.Whoami:output_type -> iam.v1.WhoamiResponse
	7, // 9: iam.v1.IAMService.GetUser:output_type -> iam.v1.GetUserResponse
