...
func (s *ServiceSuite) TestListPartSuccessFilterUUID() {
	var (
		createdAt   = time.Now()
		updatedAt   = time.Now()
		uuid        = gofakeit.UUID()
	...
	s.partRepository.EXPECT().ListPart(s.ctx, filter).Return(listPart, nil)
...
func (s *ServiceSuite) TestListPartSuccessFilterName() {
	var (
		createdAt   = time.Now()
		updatedAt   = time.Now()
		uuid        = gofakeit.UUID()
...
func (s *ServiceSuite) TestListPartSuccessFilterEmpty() {
	var (
		createdAt   = time.Now()
		updatedAt   = time.Now()
		uuid        = gofakeit.UUID()
